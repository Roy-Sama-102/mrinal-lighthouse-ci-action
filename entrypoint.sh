...
# Check if the input exists and assign it to the variable
[[ -n "$INPUT_GOOGLE_SHEETS_SERVICE_ACCOUNT_KEY" ]] && export GOOGLE_SHEETS_SERVICE_ACCOUNT_KEY="$INPUT_GOOGLE_SHEETS_SERVICE_ACCOUNT_KEY"
